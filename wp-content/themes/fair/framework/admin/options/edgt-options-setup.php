...
add_action('after_setup_theme', 'fair_edge_admin_map_init', 0);

function fair_edge_admin_map_init() {

    do_action('fair_edge_before_options_map');
    ...
    do_action('fair_edge_options_map');

    do_action('fair_edge_after_options_map');
