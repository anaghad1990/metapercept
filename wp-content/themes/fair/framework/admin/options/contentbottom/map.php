...
if ( ! function_exists('fair_edge_content_bottom_options_map') ) {

	function fair_edge_content_bottom_options_map() {
		...
		$panel_content_bottom = fair_edge_add_admin_panel(
			array(
		...
		$enable_content_bottom_area_container = fair_edge_add_admin_container(
			array(
				'parent'            => $panel_content_bottom,
	...
	add_action( 'fair_edge_options_map', 'fair_edge_content_bottom_options_map', 7);
