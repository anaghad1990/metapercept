...
$video_post_format_meta_box = fair_edge_add_meta_box(
	array(
		'scope' =>	array('post'),
...
$edgtf_video_embedded_container = fair_edge_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
...
$edgtf_video_self_hosted_container = fair_edge_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
