...
class FairEdgeIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new FairEdgeIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new FairEdgeIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('linea_icons', new FairEdgeLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new FairEdgeSimpleLineIcons('Simple Line Icons', 'simple_line_icons'));
        $this->addIconCollection('ico_moon', new FairEdgeIcoMoonIcons('Ico Moon', 'ico_moon'));
    }
    ...
    public function getIconCollectionIcons(iFairEdgeIconCollection $collection) {
...
if ( ! function_exists( 'fair_edge_activate_theme_icons' ) ) {

	function fair_edge_activate_theme_icons() {
		global $fair_edge_IconCollections;
		$fair_edge_IconCollections = FairEdgeIconCollections::get_instance();
	}

	add_action('after_setup_theme', 'fair_edge_activate_theme_icons');
}