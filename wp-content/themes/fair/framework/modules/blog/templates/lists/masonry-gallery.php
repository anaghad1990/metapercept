<?php fair_edge_get_module_template_part('templates/lists/parts/filter', 'blog'); ?>
<div class="edgtf-blog-holder edgtf-blog-type-masonry-gallery <?php echo esc_attr($blog_classes)?> edgtf-masonry-pagination-<?php echo fair_edge_options()->getOptionValue('masonry_gallery_pagination'); ?>">
