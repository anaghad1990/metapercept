...
if ( ! function_exists('fair_edge_mobile_header_options_map') ) {

	function fair_edge_mobile_header_options_map() {
		...
		$panel_mobile_header = fair_edge_add_admin_panel(array(
			'title' => 'Mobile header',
		...
		fair_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label' => 'Mobile Header Border Color',
				'description' => 'Set border color for mobile header',
				'parent' => $panel_mobile_header,
			)
		);
		...
		fair_edge_add_admin_field(
			array(
				'type' => 'text',
				'name' => 'mobile_header_border_transparency',
				'default_value' => '',
				'label' => 'Mobile Header Border Transparency',
				'description' => 'Set border transparency for mobile header',
				'parent' => $panel_mobile_header,
				'args' => array(
					'col_width' => 3
				)
		...
		fair_edge_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => fair_edge_get_text_transform_array(true)
		));
		...
		fair_edge_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => fair_edge_get_font_style_array(true)
		));
		...
		fair_edge_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => fair_edge_get_font_weight_array(true)
		));
	...
	add_action( 'fair_edge_options_map', 'fair_edge_mobile_header_options_map', 5);
