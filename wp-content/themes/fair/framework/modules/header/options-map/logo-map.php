...
if ( ! function_exists('fair_edge_logo_options_map') ) {

	function fair_edge_logo_options_map() {
		...
		$panel_logo = fair_edge_add_admin_panel(
			array(
				'page' => '_logo_page',
				'name' => 'panel_logo',
				'title' => 'Logo'
		...
		$hide_logo_container = fair_edge_add_admin_container(
			array(
				'parent' => $panel_logo,
	...
	add_action( 'fair_edge_options_map', 'fair_edge_logo_options_map', 2);
