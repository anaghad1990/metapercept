<?php
namespace FairEdge\Modules\Shortcodes\Separator;
...
class Separator implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Separator', 'fair'),
				'base' => $this->base,
				'category' => 'by EDGE',
	...
	public function render($atts, $content = null) {
		...
		$html = fair_edge_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['width'] !== '') {
			if(fair_edge_string_ends_with($params['width'], '%') || fair_edge_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(fair_edge_string_ends_with($params['top_margin'], '%') || fair_edge_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(fair_edge_string_ends_with($params['bottom_margin'], '%') || fair_edge_string_ends_with($params['bottom_margin'], 'px')) {
