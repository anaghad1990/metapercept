<?php
namespace FairEdge\Modules\Shortcodes\ElementsHolder;
...
class ElementsHolder implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Elements Holder', 'fair'),
			'base' => $this->base,
			...
			'params' => array(
				...
				array(
					...
					'value' => array(
						...
						'2 Columns(33/66)' 	=> 'two-columns-grid-33-66',
						'2 Columns(66/33)'  => 'two-columns-grid-66-33',
	...
	public function render($atts, $content = null) {
		...
		$html .= '<div ' . fair_edge_get_class_attribute($elements_holder_class) . ' ' . fair_edge_get_inline_attr($elements_holder_style, 'style'). '>';
