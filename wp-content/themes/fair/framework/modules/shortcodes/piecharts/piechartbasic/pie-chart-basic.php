<?php
namespace FairEdge\Modules\Shortcodes\PieCharts\PieChartBasic;
...
class PieChartBasic implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Pie Chart', 'fair'),
			'base' => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$html = fair_edge_get_shortcode_module_template_part('templates/pie-chart-basic', 'piecharts/piechartbasic', '', $params);
