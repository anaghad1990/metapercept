<?php
namespace FairEdge\Modules\Shortcodes\UnorderedList;
...
class UnorderedList implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('List - Unordered', 'fair'),
			'base' => $this->base,
	...
	public function render($atts, $content = null) {
        ...
        $html = '<div class="edgtf-unordered-list '.$list_item_classes.'" '.  fair_edge_get_inline_style($list_style).'>'.do_shortcode($content).'</div>';
        return $html;
	}
}