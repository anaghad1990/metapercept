<?php
namespace FairEdge\Modules\Shortcodes\Button;
 ...
 * @package FairEdge\Modules\Shortcodes\Button
 */
class Button implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            ...
            'params'                    => array_merge(
                ...
                fair_edge_icon_collections()->getVCParamsArray(array(), '', true),
                array(
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Color',
                        ...
                        'admin_label' => true,
                        'dependency'  => array('element' => 'type', 'value' => array('solid','outline','','solid-two')),
                    ),
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Hover Color',
                    ...
                    array(
                        ...
                        'admin_label' => true,
                        'dependency'  => array('element' => 'type', 'value' => array('solid','solid-two')),
                        'group'       => 'Design Options'
                    ),
                    array(
                        'type'        => 'colorpicker',
                    ...
                    array(
                        ...
                        'value'       => array_flip(fair_edge_get_font_weight_array(true)),
                        'admin_label' => true,
                        'group'       => 'Design Options'
                    ),
                    array(
                        ...
                        'heading'     => 'Margin',
                        'param_name'  => 'margin',
                        'description' => esc_html__('Insert margin in format: 0px 0px 1px 0px', 'fair'),
                        'admin_label' => true,
                        'group'       => 'Design Options'
                    )
                )
    ...
    public function render($atts, $content = null) {
        ...
        return fair_edge_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', $params['hover_animation'], $params);
    }
    ...
    private function getButtonStyles($params) {
        ...
        if(!empty($params['font_size'])) {
            $styles[] = 'font-size: '.fair_edge_filter_px($params['font_size']).'px';
        }
