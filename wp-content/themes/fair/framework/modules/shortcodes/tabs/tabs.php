<?php
namespace FairEdge\Modules\Shortcodes\Tabs;
...
class Tabs implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$output .= fair_edge_get_shortcode_module_template_part('templates/tab-template','tabs', '', $params);
