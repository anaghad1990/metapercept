...
if(!function_exists('fair_edge_tabs_map')) {
    function fair_edge_tabs_map() {
		...
		$tabs_color_group = fair_edge_add_admin_group(array(
            'name' => 'tabs_color_group',
            'title' => 'Tab Navigation Color Styles',
			'description' => 'Set color styles for tab navigation',
            'parent' => $panel
        ));
		$tabs_color_row = fair_edge_add_admin_row(array(
            'name' => 'tabs_color_row',
            'next' => true,
		...
		$active_tabs_color_group = fair_edge_add_admin_group(array(
		...
		$active_tabs_color_row = fair_edge_add_admin_row(array(
    ...
    add_action('fair_edge_options_elements_map', 'fair_edge_tabs_map');
}