<?php
namespace FairEdge\Modules\Shortcodes\CustomFont;
...
class CustomFont implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Custom Font', 'fair'),
				'base' => $this->getBase(),
				'category' => 'by EDGE',
				...
				'params' => array(
					...
					array(
						...
						"value" => fair_edge_get_font_style_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
						...
						"value" => fair_edge_get_font_weight_array(),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => fair_edge_get_text_transform_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
	...
	public function render($atts, $content = null) {
		...
		$html = fair_edge_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
