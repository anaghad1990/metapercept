...
if ( ! function_exists('fair_edge_fullscreen_menu_options_map')) {

	function fair_edge_fullscreen_menu_options_map() {
...
//		);
		...
		$fullscreen_panel = fair_edge_add_admin_panel(
			array(
				'title' => 'Fullscreen Menu',
		...
		$background_group = fair_edge_add_admin_group(
			array(
				'parent' => $fullscreen_panel,
		...
		$background_group_row = fair_edge_add_admin_row(
			array(
...
//1st level style group
		$first_level_style_group = fair_edge_add_admin_group(
			array(
				'parent' => $fullscreen_panel,
		...
		$first_level_style_row1 = fair_edge_add_admin_row(
			array(
		...
		$first_level_style_row2 = fair_edge_add_admin_row(
			array(
				'parent' => $first_level_style_group,
		...
		$first_level_style_row3 = fair_edge_add_admin_row(
			array(
				'parent' => $first_level_style_group,
		...
		$first_level_style_row4 = fair_edge_add_admin_row(
			array(
				'parent' => $first_level_style_group,
...
//2nd level style group
		$second_level_style_group = fair_edge_add_admin_group(
			array(
				'parent' => $fullscreen_panel,
		...
		$second_level_style_row1 = fair_edge_add_admin_row(
			array(
		...
		$second_level_style_row2 = fair_edge_add_admin_row(
			array(
				'parent' => $second_level_style_group,
		...
		$second_level_style_row3 = fair_edge_add_admin_row(
			array(
				'parent' => $second_level_style_group,
		...
		$third_level_style_group = fair_edge_add_admin_group(
			array(
				'parent' => $fullscreen_panel,
		...
		$third_level_style_row1 = fair_edge_add_admin_row(
			array(
		...
		$third_level_style_row2 = fair_edge_add_admin_row(
			array(
				'parent' => $third_level_style_group,
				'name' => 'second_level_style_row2'
			)
		...
		$third_level_style_row3 = fair_edge_add_admin_row(
			array(
				'parent' => $third_level_style_group,
				'name' => 'second_level_style_row3'
			)
		...
		$icon_colors_group = fair_edge_add_admin_group(
			array(
				'parent' => $fullscreen_panel,
		...
		$icon_colors_row1 = fair_edge_add_admin_row(
			array(
		...
		$icon_colors_row2 = fair_edge_add_admin_row(
			array(
				'parent' => $icon_colors_group,
		...
		$icon_colors_row3 = fair_edge_add_admin_row(
			array(
				'parent' => $icon_colors_group,
		...
		$icon_colors_row4 = fair_edge_add_admin_row(
			array(
				'parent' => $icon_colors_group,
	...
	add_action('fair_edge_options_map', 'fair_edge_fullscreen_menu_options_map', 16);
