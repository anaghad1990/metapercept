...
if ( ! function_exists('fair_edge_portfolio_options_map') ) {

	function fair_edge_portfolio_options_map() {
		...
		fair_edge_add_admin_field(array(
			...
			'options'     => array(
                ...
                'big-images-bottom' => 'Portfolio big images bottom',
                'full-width-images' => 'Portfolio full width images',
		...
		fair_edge_add_admin_field(array(
			...
			'type'          => 'yesno',
			'label'         => 'Show Comments',
			'description'   => 'Enabling this option will show comments on your portfolio.',
			'parent'        => $panel,
			'default_value' => 'no'
		));
		...
		$container_navigate_category = fair_edge_add_admin_container(array(
	...
	add_action( 'fair_edge_options_map', 'fair_edge_portfolio_options_map', 13);
