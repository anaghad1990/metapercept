<?php
class devn_options_upload extends devn_options{	
	...
	*/
	function render(){
		...
		<div class="king-upload-wrp">
			...
			<img style="max-width: 100%; cursor: pointer;<?php if( empty($this->value) ){echo 'display: none;';} ?>" src="<?php echo esc_url( isset($this->value)?$this->value:'' ); ?>" class="king-upload-image" />
			<p>
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			...
			devn_options_URL.'fields/upload/field_upload.js', 
		...
		wp_enqueue_media();
		wp_localize_script('nhp-opts-field-upload-js', 'devn_upload', array('url' => $this->url.'fields/upload/blank.png'));
