<?php
class devn_options_colorStyle extends devn_options{	
	...
	*/
	...
	<div id="style-selector" class="inOptions">
		<ul class="styles" id="list-style-colors">     
		    <li>
		    	<a href="#" title="Default"><span class="pre-color-skin0 pre-color-skin1">Default</span></a>
		    	<br />
			...
			?>
				<li>
			    	...
			    	<br />
			    	<input type="radio" <?php if($df == $arg[2]){echo 'checked="checked"';$df = '';} ?> name="devn[colorStyle]" value="<?php echo esc_attr($arg[2]); ?>" />
			    </li>
			<?php		
				}
			...
			<li class="customLi">
		    	...
		    	<span>
		    		Custom 
		    		<input placeholder="Select Color" <?php if($df!='')echo 'checked="checked"'; ?> id="targetCustomStyle" type="radio" name="devn[colorStyle]" value="<?php echo esc_attr($df); ?>" />
		    	</span>
		    </li>
		</ul>
		<br />
		<?php
			...
			_e( 'Primary css file has been located at: /wp_content/themes/__name__/assets/css/colors/color-primary.css', 'aaikadomain' );
