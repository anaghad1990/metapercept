...
/**
*
* (c) www.king-theme.com /Init widgets
*
*/
	...
	<section class="wrap col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
			...
			<div class="row" style="padding: 20px">
				...
				<section class="content col-md-12">
					...
					?>
						<img src="<?php echo THEME_URI; ?>/core/assets/images/king-gray.png" width="50" class="pull-right" />
						<div id="errorImportMsg" class="p" style="width:100%;"></div>
						<div id="importWorking">
							<h2 style="color: #30bfbf;">The importer is working</h2>
							<p>Please don't navigate away while importing. If it stops working, just import again and it will continue.</p>
							<i>Processing: <span id="import-status" style="font-size: 12px;color: maroon;"></span></i>
					...
					<?php	
						...
						include THEME_PATH.DS.'core'.DS.'sample'.DS.'devnImporter.php';						
						...
						<div class="h4">
							<p>We will redirect you to homepage after <span id="countdown">10</span> seconds. 
								...
								<a href="#" onclick="clearTimeout(countdownTimer)">
								 ...
								 or go to 
								<a href="<?php echo admin_url('admin.php?page=aaika-panel'); ?>" onclick="clearTimeout(countdownTimer)">
									Theme Panel
								</a>
							</p>
						</div>		
					...
					<form action="" method="post" onsubmit="doSubmit(this)">
						...
						<div class="bs-callout bs-callout-info">
							<h4><?php _e('Sample Data', 'aaikadomain' ); ?></h4>			
							<div class="p">
								<p>
								...
								<br />
								We suggest you use the plugin <a href="<?php echo esc_url(SITE_URI); ?>/wp-admin/plugin-install.php?tab=plugin-information&plugin=wordpress-reset&from=aaika-theme&TB_iframe=true&width=800&height=550" class="thickbox" title="Install Wordpress Reset">"Wordpress Reset"</a> to reset your website before import. <br />
								<i>( After install plugin <a href="<?php echo esc_url(SITE_URI); ?>/wp-admin/plugin-install.php?tab=plugin-information&plugin=wordpress-reset&from=aaika-theme&TB_iframe=true&width=800&height=550" class="thickbox" title="Install Wordpress Reset">"Wordpress Reset"</a> go to: Tool -> reset )</i>
							</div>		
						</div>	
						...
						<div class="p">
							<p>
								<label class="label-form-sel">
									We required using 3 plugins ( Visual Composer, Layer Slider & Contact Form 7  )
								</label>
								<br />
								...
								<br />
								<br />
								<i class="sub-label-form-sel">Plugins will be installed automatically during installation.<br /> You also able to find the installation files in the directory: wp-content/themes/aaika/core/sample/plugins</i>
			...
			<section class="col-md-12">
				...
				<div class="footer">
					...
					&copy; Aaika ver <?php global $devn_options; echo DEVN_VERSION; ?> by <a href="<?php echo esc_url('http://king-theme.com'); ?>">King-Theme</a>
					|  <a href="<?php echo esc_url('http://help.king-theme.com'); ?>">Help.King-Theme.com</a>
					
					<a onclick="clearTimeout(countdownTimer)" class="pull-right link btn btn-default" class="btn btn-default" href="<?php echo admin_url('admin.php?page=aaika-panel'); ?>">
