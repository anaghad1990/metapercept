...
class flickr_photos extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo '<div class="devn-preload flickr_badge_wrapper" data-option="flickr|'.str_replace( array("'",'"','|'), array('','',''), $id ).'|'.$amount.'"><i class="fa fa-spinner fa-spin"></i>  Initializing...</div>';
		print( $after_widget );
	...
	function form( $instance ) {
		$defaults = array( 'flickr_title' =>__( 'Flickr' , 'aaikadomain'), 'no_of_photos' => '6' , 'flickr_display' => 'latest', 'flickr_id'=>'', 'class' => '' );
