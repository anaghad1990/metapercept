...
class widget_tabs extends WP_Widget {
	...
	?>
		<div id="tabs">
			...
			<ul class="tabs">
				<li class="active"><a href="#tab1"><?php _e( 'Popular' , 'aaikadomain' ) ?></a></li>
				<li><a href="#tab2"><?php _e( 'Recent' , 'aaikadomain' ) ?></a></li>
				<li><a href="#tab3"><?php _e( 'Tags' , 'aaikadomain' ) ?></a></li>
			</ul>

			<div id="tab1" class="tab_container" style="display: block;">
				<ul class="recent_posts_list">
					<?php $devn->popular_posts() ?>	
				</ul>
			</div>
