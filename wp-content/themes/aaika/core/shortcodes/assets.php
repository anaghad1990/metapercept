...
class devn_shortcode_assets {
	...
	public static function register() {
		...
		wp_register_script('devn-shortcode', THEME_URI.'/core/shortcodes/assets/js/shortcode.js', false, DEVN_VERSION, true );
		wp_enqueue_script('devn-shortcode');
		...
		wp_localize_script( 'magnific-popup', 'su_magnific_popup', array(
				'close'   => __( 'Close (Esc)', 'aaikadomain' ),
				'loading' => __( 'Loading...', 'aaikadomain' ),
				'prev'    => __( 'Previous (Left arrow key)', 'aaikadomain' ),
				'next'    => __( 'Next (Right arrow key)', 'aaikadomain' ),
				'counter' => sprintf( __( '%s of %s', 'aaikadomain' ), '%curr%', '%total%' ),
				'error'   => sprintf( __( 'Failed to load this link. %sOpen link%s.', 'aaikadomain' ), '<a href="%url%" target="_blank"><u>', '</u></a>' )
			) );
		...
		wp_register_style( 'progress-bar', THEME_URI.'/core/shortcodes/assets/css/ui.progress-bar.css', false , DEVN_VERSION, 'all' );
		...
		// Options page
		wp_register_style( 'devn-options-page', THEME_URI.'/core/shortcodes/assets/css/options-page.css' , false, DEVN_VERSION, 'all' );
		wp_register_script( 'devn-options-page', THEME_URI.'/core/shortcodes/assets/js/options-page.js' , array( 'magnific-popup', 'jquery-ui-sortable', 'ace', 'jsrender' ), DEVN_VERSION, true );
		wp_localize_script( 'devn-options-page', 'su_options_page', array(
				'upload_title'  => __( 'Choose files', 'aaikadomain' ),
				'upload_insert' => __( 'Add selected files', 'aaikadomain' ),
				'not_clickable' => __( 'This button is not clickable', 'aaikadomain' )
			) );
		// Generator
		wp_register_style( 'devn-generator', THEME_URI.'/core/shortcodes/assets/css/generator.css', array( 'farbtastic', 'magnific-popup' ), DEVN_VERSION, 'all' );
		wp_register_script( 'devn-generator', THEME_URI.'/core/shortcodes/assets/js/generator.js', array( 'farbtastic', 'magnific-popup', 'qtip' ), DEVN_VERSION, true );
		wp_localize_script( 'devn-generator', 'devn_Shortcode_Generator', array(
				'upload_title'         => __( 'Choose file', 'aaikadomain' ),
				'upload_insert'        => __( 'Insert', 'aaikadomain' ),
				'isp_media_title'      => __( 'Select images', 'aaikadomain' ),
				'isp_media_insert'     => __( 'Add selected images', 'aaikadomain' ),
				'presets_prompt_msg'   => __( 'Please enter a name for new preset', 'aaikadomain' ),
				'presets_prompt_value' => __( 'New preset', 'aaikadomain' ),
				'last_used'            => __( 'Last used settings', 'aaikadomain' )
			) );
		// Shortcodes stylesheets
		wp_register_style( 'devn-flex-slider-css', THEME_URI.'/css/flexslider.css', false, DEVN_VERSION, 'all' );
		wp_register_style( 'devn-content-shortcodes', self::skin_url( 'content-shortcodes.css' ), false, DEVN_VERSION, 'all' );
		wp_register_style( 'devn-box-shortcodes', self::skin_url( 'box-shortcodes.css' ), false, DEVN_VERSION, 'all' );
		wp_register_style( 'devn-media-shortcodes', self::skin_url( 'media-shortcodes.css' ), false, DEVN_VERSION, 'all' );
		wp_register_style( 'devn-galleries-shortcodes', self::skin_url( 'galleries-shortcodes.css' ), false, DEVN_VERSION, 'all' );
		wp_register_style( 'devn-players-shortcodes', self::skin_url( 'players-shortcodes.css' ), false, DEVN_VERSION, 'all' );
		// Shortcodes scripts

		wp_register_script( 'devn-flex-slider', THEME_URI.'/js/jquery.flexslider.js', array( 'jquery', 'swiper' ), DEVN_VERSION, true );
		
		wp_register_script( 'devn-galleries-shortcodes', THEME_URI.'/core/shortcodes/assets/js/galleries-shortcodes.js', array( 'jquery', 'swiper' ), DEVN_VERSION, true );
		wp_register_script( 'devn-players-shortcodes', THEME_URI.'/core/shortcodes/assets/js/players-shortcodes.js', array( 'jquery', 'jplayer' ), DEVN_VERSION, true );
		wp_register_script( 'devn-other-shortcodes', THEME_URI.'/core/shortcodes/assets/js/other-shortcodes.js', array( 'jquery' ), DEVN_VERSION, true );
...
function su_query_asset( $type, $handle ) {
	devn_shortcode_assets::add( $type, $handle );
}
...
function su_skin_url( $file ) {
	return devn_shortcode_assets::skin_url( $file );
}
