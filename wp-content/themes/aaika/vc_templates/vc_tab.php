...
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'devn-tabs-pane devn-clearfix ui-tabs-panel wpb_ui-tabs-hide', $this->settings['base'], $atts );
