...
global $woocommerce_loop, $blog_id, $devn;

get_header();

if( !woo_gate( __FILE__ , true ) ){return;}

$cookie_shop_layout = 'devn_' . get_template() . ( is_multisite() ? '_' . $blog_id : '' ) . '_shop_layout';
$woocommerce_loop['view'] = isset( $_COOKIE[ $cookie_shop_layout ] ) ? $_COOKIE[ $cookie_shop_layout ] : (!empty($devn->cfg['woo_product_display'])?$devn->cfg['woo_product_display']:15);
	...
	<div id="primary" class="single-product-content content">
		<div class="container">
			...
			?>
		        ...
		        /* <![CDATA[ */
		        var devn_shop_view_cookie = '<?php echo esc_attr( $cookie_shop_layout ); ?>';
		        /* ]]> */
		        </script>
			<?php
				/**
