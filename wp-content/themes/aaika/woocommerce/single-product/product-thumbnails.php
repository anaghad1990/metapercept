...
global $post, $product, $woocommerce, $devn;

if( empty( $devn->cfg['mg_thumbnail_slider'] ) ){
	$devn->cfg['mg_thumbnail_slider'] = 1;
}
$slider_active = $devn->cfg['mg_thumbnail_slider'] == 1 ? true : false ;

$slider_item = !empty( $devn->cfg['mg_slider_item'] )?$devn->cfg['mg_slider_item']:1; 
