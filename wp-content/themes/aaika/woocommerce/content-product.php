...
global $product, $woocommerce_loop, $devn;
...
$items = 4;
if( !empty( $devn->cfg['woo_grids'] ) ){
	$items = $devn->cfg['woo_grids'];
}
...
?>
<li <?php post_class( implode( ' ', $classes )." animated eff-fadeIn ".$woocommerce_loop['view'] ); ?>>
