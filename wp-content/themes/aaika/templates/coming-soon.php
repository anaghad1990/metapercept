...
?>
<link href="<?php echo THEME_URI; ?>/assets/js/coming_soon/animations.min.css" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" media="screen" href="<?php echo THEME_URI; ?>/assets/js/coming_soon/coming.css" type="text/css" />
<script src="<?php echo THEME_URI; ?>/assets/js/jquery/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="<?php echo THEME_URI; ?>/assets/js/coming_soon/jquery.bcat.bgswitcher.js"></script>
	...
	<div class="comingsoon_page">
		<div class="container">
			<div class="topcontsoon">
				<img src="<?php echo THEME_URI; ?>/assets/images/logo-2.png" alt="" />
				<div class="clearfix">
				</div>
				<h5>
					<?php _e('We\'re Launching Soon', 'aaikadomain' ); ?>
				</h5>
			</div>
			<!-- end section -->
			...
			<div class="socialiconssoon">
				<p>
					<?php _e("Our website is under construction. We'll be here soon with our new awesome site. Get best experience with this one.", 'aaikadomain' ); ?>
				</p>
...
<!-- ######### JS FILES ######### -->
<script type="text/javascript" src="<?php echo THEME_URI; ?>/assets/js/coming_soon/countdown.js"></script>
<!-- animations -->
<script src="<?php echo THEME_URI; ?>/assets/js/coming_soon/animations.min.js" type="text/javascript"></script>
