		...
		<div id="content" class="row row-content container">
			<div class="col-md-9">
				...
				<?php if ( have_posts() ) : ?>
					...
					<header>
						<h1 class="page-title author"><?php printf( __( 'Author Archives: %s', 'aaikadomain' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?></h1>
					</header>
					...
					<div class="about_author">
						...
						<h3><?php printf( __( 'About %s', 'aaikadomain' ), get_the_author() ); ?></h3>
