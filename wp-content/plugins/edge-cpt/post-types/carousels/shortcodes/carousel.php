...
class Carousel implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($carousel !== '') {
            ...
            $html .= '<div class="edgtf-carousel edgtf-slick-slider-navigation-style" ' .  edge_cpt_get_inline_attrs($carousel_data_attributes) . '>';
    ...
    private function getUnderlineHtml($params) {
        ...
        if ($params['image_animation'] == 'underline'){
            ...
            $underline .= '<span class="edgtf-carousel-underline" '.edge_cpt_get_inline_style($style).'></span>';
        }
