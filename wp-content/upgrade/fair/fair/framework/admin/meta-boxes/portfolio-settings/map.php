...
if(!function_exists('fair_edge_map_portfolio_settings')) {
    function fair_edge_map_portfolio_settings() {
    ...
    add_action('fair_edge_meta_boxes_map', 'fair_edge_map_portfolio_settings');
}