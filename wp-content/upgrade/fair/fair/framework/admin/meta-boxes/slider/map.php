...
$slider_meta_box = fair_edge_add_meta_box(
	array(
		'scope' => array('slides'),
...
$image_meta_container = fair_edge_add_admin_container(
	array(
...
$video_meta_container = fair_edge_add_admin_container(
	array(
...
$slide_video_overlay_container = fair_edge_add_admin_container(array(
...
$elements_meta_box = fair_edge_add_meta_box(
	array(
		'scope' => array('slides'),
...
fair_edge_add_slide_holder_frame_scheme(
	array(
		'parent' => $elements_meta_box
	)
);
...
$holder_frame = fair_edge_add_admin_group(array(
...
$row1 = fair_edge_add_admin_row(array(
	'name' => 'row1',
	'parent' => $holder_frame
));

$holder_frame_width = fair_edge_add_meta_box_field(
	array(
...
$holder_frame_height = fair_edge_add_meta_box_field(
	array(
...
$holder_frame_responsive_container = fair_edge_add_admin_container(array(
...
$holder_frame_responsive = fair_edge_add_admin_group(array(
...
$row2 = fair_edge_add_admin_row(array(
	'name' => 'row2',
...
$row3 = fair_edge_add_admin_row(array(
	'name' => 'row3',
	'parent' => $holder_frame_responsive
));
...
$slide_elements = fair_edge_add_slide_elements_framework(
	array(
		'parent' => $elements_meta_box,
...
$behaviours_meta_box = fair_edge_add_meta_box(
	array(
		'scope' => array('slides'),
...
$enable_image_animation_container = fair_edge_add_admin_container(array(
