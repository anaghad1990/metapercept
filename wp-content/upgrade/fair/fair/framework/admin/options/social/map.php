...
if ( ! function_exists('fair_edge_social_options_map') ) {

	function fair_edge_social_options_map() {
		 ...
		 * Enable Social Share
		 */
		$panel_social_share = fair_edge_add_admin_panel(array(
			'page'  => '_social_page',
		...
		$panel_show_social_share_on = fair_edge_add_admin_panel(array(
			'page'  			=> '_social_page',
		 ...
		 */
		$panel_social_networks = fair_edge_add_admin_panel(array(
			'page'  			=> '_social_page',
		...
		$enable_facebook_share_container = fair_edge_add_admin_container(array(
		...
		$enable_twitter_share_container = fair_edge_add_admin_container(array(
		...
		$enable_google_plus_container = fair_edge_add_admin_container(array(
		...
		$enable_linkedin_container = fair_edge_add_admin_container(array(
		...
		$enable_tumblr_container = fair_edge_add_admin_container(array(
		...
		$enable_pinterest_container = fair_edge_add_admin_container(array(
		...
		$enable_vk_container = fair_edge_add_admin_container(array(
		...
		if(defined('EDGEF_TWITTER_FEED_VERSION')) {
            $twitter_panel = fair_edge_add_admin_panel(array(
                'title' => 'Twitter',
                'name'  => 'panel_twitter',
                'page'  => '_social_page'
            ));

            fair_edge_add_admin_twitter_button(array(
                'name'   => 'twitter_button',
        ...
        if(defined('EDGEF_INSTAGRAM_FEED_VERSION')) {
            $instagram_panel = fair_edge_add_admin_panel(array(
                'title' => 'Instagram',
                'name'  => 'panel_instagram',
                'page'  => '_social_page'
            ));

            fair_edge_add_admin_instagram_button(array(
	...
	add_action( 'fair_edge_options_map', 'fair_edge_social_options_map', 17);
}