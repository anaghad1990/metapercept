...
if ( ! function_exists('fair_edge_sidebar_options_map') ) {

	function fair_edge_sidebar_options_map() {
		...
		$panel_widgets = fair_edge_add_admin_panel(
			array(
				'page'  => '_sidebar_page',
				'name'  => 'panel_widgets',
				'title' => 'Widgets'
		...
		$group_sidebar_padding = fair_edge_add_admin_group(array(
			'name'		=> 'group_sidebar_padding',
			'title'		=> 'Padding',
			'parent'	=> $panel_widgets
		));

		$row_sidebar_padding = fair_edge_add_admin_row(array(
	...
	add_action( 'fair_edge_options_map', 'fair_edge_sidebar_options_map', 9);
