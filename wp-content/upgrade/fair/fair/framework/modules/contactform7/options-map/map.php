...
if ( ! function_exists('fair_edge_contact_form_7_options_map') ) {

	function fair_edge_contact_form_7_options_map() {

		fair_edge_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> 'Contact Form 7',
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = fair_edge_add_admin_panel(array(
		...
		$typography_text_group = fair_edge_add_admin_group(array(
		...
		$typography_text_row1 = fair_edge_add_admin_row(array(
		...
		$typography_text_row2 = fair_edge_add_admin_row(array(
		...
		$typography_text_row3 = fair_edge_add_admin_row(array(
		...
		$typography_label_group = fair_edge_add_admin_group(array(
		...
		$typography_label_row1 = fair_edge_add_admin_row(array(
		...
		$typography_label_row2 = fair_edge_add_admin_row(array(
		...
		$background_border_group = fair_edge_add_admin_group(array(
		...
		$background_border_row1 = fair_edge_add_admin_row(array(
		...
		$background_border_row2 = fair_edge_add_admin_row(array(
		...
		$background_border_row3 = fair_edge_add_admin_row(array(
		...
		$padding_group = fair_edge_add_admin_group(array(
			'name'			=> 'padding_group',
		...
		$padding_row = fair_edge_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		$margin_group = fair_edge_add_admin_group(array(
			'name'			=> 'margin_group',
		...
		$margin_row = fair_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = fair_edge_add_admin_group(array(
		...
		$button_typography_row1 = fair_edge_add_admin_row(array(
		...
		$button_typography_row2 = fair_edge_add_admin_row(array(
		...
		$button_background_border_group = fair_edge_add_admin_group(array(
		...
		$button_background_border_row1 = fair_edge_add_admin_row(array(
		...
		$button_background_border_row2 = fair_edge_add_admin_row(array(
		...
		$button_background_border_row3 = fair_edge_add_admin_row(array(
		...
		$panel_contact_form_style_2 = fair_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
		...
		$panel_contact_form_style_3 = fair_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
	...
	add_action( 'fair_edge_options_map', 'fair_edge_contact_form_7_options_map', 19);
