...
if ( ! function_exists('fair_edge_sidearea_options_map') ) {

	function fair_edge_sidearea_options_map() {
		...
		$side_area_panel = fair_edge_add_admin_panel(
			array(
				'title' => 'Side Area',
				'name' => 'side_area',
		...
		$side_area_width_container = fair_edge_add_admin_container(
			array(
				'parent' => $side_area_panel,
		...
		fair_edge_add_admin_field(
			array(
				...
				'description' => 'Enter a width for Side Area, not less than 270px',
				'args' => array(
					'col_width' => 3,
					'suffix' => 'px'
				)
		...
		$side_area_slide_with_content_container = fair_edge_add_admin_container(
			array(
				'parent' => $side_area_panel,
...
//do we have some collection added in collections array?
		if (is_array(fair_edge_icon_collections()->iconCollections) && count(fair_edge_icon_collections()->iconCollections)) {
			//get collections params array. It will contain values of 'param' property for each collection
			$side_area_icon_collections_params = fair_edge_icon_collections()->getIconCollectionsParams();

			//foreach collection generate hide and show array
			foreach (fair_edge_icon_collections()->iconCollections as $dep_collection_key => $dep_collection_object) {
		...
		fair_edge_add_admin_field(
			array(
				...
				'options' => fair_edge_icon_collections()->getIconCollections(),
				'args' => array(
					'dependence' => true,
...
//			foreach (fair_edge_icon_collections()->iconCollections as $collection_key => $collection_object) {
//				$icons_array = $collection_object->getIconsArray();
//
//				//get icon collection keys (keys from collections array, e.g 'font_awesome', 'font_elegant' etc.)
//				$icon_collections_keys = fair_edge_icon_collections()->getIconCollectionsKeys();
//
...
//
//				$side_area_icon_container = fair_edge_add_admin_container(
//					array(
//						'parent' => $side_area_panel,
...
//		}
		...
		$side_area_icon_style_group = fair_edge_add_admin_group(
			array(
				'parent' => $side_area_panel,
		...
		$side_area_icon_style_row1 = fair_edge_add_admin_row(
			array(
		...
		$side_area_icon_style_row2 = fair_edge_add_admin_row(
			array(
				'parent'		=> $side_area_icon_style_group,
		...
		$side_area_icon_style_row3 = fair_edge_add_admin_row(
			array(
				'parent'		=> $side_area_icon_style_group,
		...
		$icon_spacing_group = fair_edge_add_admin_group(
			array(
				'parent' => $side_area_panel,
		...
		$icon_spacing_row = fair_edge_add_admin_row(
			array(
		...
		$side_area_icon_border_container = fair_edge_add_admin_container(
			array(
				'parent' => $side_area_panel,
		...
		$border_style_group = fair_edge_add_admin_group(
			array(
		...
		$border_style_row_1 = fair_edge_add_admin_row(
			array(
		...
		$border_style_row_2 = fair_edge_add_admin_row(
			array(
				'parent'		=> $border_style_group,
		...
		$background_color_group = fair_edge_add_admin_group(
			array(
				'parent' => $side_area_panel,
				'name' => 'background_color_group',
				'title' => 'Background Color',
				'description' => 'Choose background color for Side Area'
			)
		);

		fair_edge_add_admin_field(
			array(
				'parent' => $background_color_group,
				'type' => 'colorsimple',
		...
		fair_edge_add_admin_field(
			array(
				'parent' => $background_color_group,
				'type' => 'textsimple',
				'name' => 'side_area_background_color_opacity',
				'default_value' => '',
				'label' => 'Opacity (0-1)',
				'description' => '',
			)
		...
		$padding_group = fair_edge_add_admin_group(
			array(
				'parent' => $side_area_panel,
				'name' => 'padding_group',
				'title' => 'Padding',
		...
		$padding_row = fair_edge_add_admin_row(
			array(
		...
		$title_group = fair_edge_add_admin_group(
			array(
				'parent' => $side_area_panel,
				'name' => 'title_group',
				'title' => 'Title',
		...
		$title_row_1 = fair_edge_add_admin_row(
			array(
				'parent' => $title_group,
				'name' => 'title_row_1',
			)
		...
		$title_row_2 = fair_edge_add_admin_row(
			array(
				'parent' => $title_group,
				'name' => 'title_row_2',
				'next' => true
		...
		$text_group = fair_edge_add_admin_group(
			array(
				'parent' => $side_area_panel,
				'name' => 'text_group',
				'title' => 'Text',
		...
		$text_row_1 = fair_edge_add_admin_row(
			array(
				'parent' => $text_group,
				'name' => 'text_row_1',
			)
		...
		$text_row_2 = fair_edge_add_admin_row(
			array(
				'parent' => $text_group,
				'name' => 'text_row_2',
				'next' => true
		...
		$widget_links_group = fair_edge_add_admin_group(
			array(
				'parent' => $side_area_panel,
		...
		$widget_links_row_1 = fair_edge_add_admin_row(
			array(
		...
		$widget_links_row_2 = fair_edge_add_admin_row(
			array(
				'parent' => $widget_links_group,
		...
		$widget_links_row_3 = fair_edge_add_admin_row(
			array(
				'parent' => $widget_links_group,
		...
		$side_area_bottom_border_container = fair_edge_add_admin_container(
			array(
				'parent' => $side_area_panel,
	...
	add_action('fair_edge_options_map', 'fair_edge_sidearea_options_map', 14);
