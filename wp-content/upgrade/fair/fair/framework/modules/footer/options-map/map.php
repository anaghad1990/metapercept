...
if ( ! function_exists('fair_edge_footer_options_map') ) {
	/**
	 * Add footer options
	 */
	function fair_edge_footer_options_map() {
		...
		$footer_panel = fair_edge_add_admin_panel(
			array(
				'title' => 'Footer',
				'name' => 'footer',
				'page' => '_footer_page'
		...
		$show_footer_top_container = fair_edge_add_admin_container(
			array(
		...
		$show_footer_bottom_container = fair_edge_add_admin_container(
			array(
	...
	add_action( 'fair_edge_options_map', 'fair_edge_footer_options_map', 10);
