 ...
 */
class FairEdgeSocialIconWidget extends FairEdgeWidget {
    /**
    ...
    protected function setParams() {
        $this->params = array_merge(
            fair_edge_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'title' => 'Link',
    ...
    public function widget($args, $instance) {
        ...
        <a class="edgtf-social-icon-widget-holder" <?php echo fair_edge_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php fair_edge_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
