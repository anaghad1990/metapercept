...
class Countdown implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Countdown', 'fair'),
			'base' => $this->getBase(),
			'category' => 'by EDGE',
	...
	public function render($atts, $content = null)
	{
		...
		if($params['digit_color'] != ''){
			$digit_style[] = 'color:' . $params['digit_color'];
		}

		$params['digit_style'] = $digit_style;
		//Get HTML from template
		$html = fair_edge_get_shortcode_module_template_part('templates/countdown-template', 'countdown', '', $params);
