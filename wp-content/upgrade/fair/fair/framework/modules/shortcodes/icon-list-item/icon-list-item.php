<?php
namespace FairEdge\Modules\Shortcodes\IconListItem;
...
class IconListItem implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Icon List Item', 'fair'),
			'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$html = fair_edge_get_shortcode_module_template_part('templates/icon-list-item-template', 'icon-list-item', '', $params);
		return $html;
	}
	 /**
	...
	private function getIconStyle($params){
		...
		if (!empty($params['icon_size'])) {
			$iconStylesArray[] = 'font-size:' .fair_edge_filter_px( $params['icon_size']) . 'px';
		}
	...
	private function getTitleStyle($params){
		...
		if (!empty($params['title_size'])) {
			$titleStylesArray[] = 'font-size:' .fair_edge_filter_px( $params['title_size']) . 'px';
		}
