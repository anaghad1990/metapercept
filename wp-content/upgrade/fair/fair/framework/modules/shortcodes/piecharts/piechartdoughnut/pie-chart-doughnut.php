<?php
namespace FairEdge\Modules\Shortcodes\PieCharts\PieChartDoughnut;
...
class PieChartDoughnut implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Pie Chart 3 (Doughnut)', 'fair'),
			'base' => $this->getBase(),
			'category' => 'by EDGE',
	...
	public function render($atts, $content = null) {
		...
		$html = fair_edge_get_shortcode_module_template_part('templates/pie-chart-doughnut', 'piecharts/piechartdoughnut', '', $params);
