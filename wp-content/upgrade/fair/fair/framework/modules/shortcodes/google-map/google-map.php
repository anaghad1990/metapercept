<?php
namespace FairEdge\Modules\Shortcodes\GoogleMap;
...
class GoogleMap implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Google Map', 'fair'),
				'base' => $this->base,
				'category' => 'by EDGE',
	...
	public function render($atts, $content = null) {
		...
		$html = fair_edge_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
