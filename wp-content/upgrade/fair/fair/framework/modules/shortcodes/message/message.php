<?php
namespace FairEdge\Modules\Shortcodes\Message;
...
class Message implements ShortcodeInterface	{
	...
	public function vcMap() {
		...
		vc_map( array(
			...
			'params' => array_merge(
				...
				\FairEdgeIconCollections::get_instance()->getVCParamsArray(array('element' => 'type', 'value' => 'with_icon')),
				array(
					array(
						'type' => 'colorpicker',
						'heading' => 'Icon Color',
	...
	public function render($atts, $content = null) {
		...
		$html = fair_edge_get_shortcode_module_template_part('templates/message-holder-template', 'message', '', $params);
