<?php
namespace FairEdge\Modules\Shortcodes\Blockquote;
...
class Blockquote implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Blockquote', 'fair'),
				'base' => $this->getBase(),
				'category' => 'by EDGE',
	...
	public function render($atts, $content = null) {
		...
		$html = fair_edge_get_shortcode_module_template_part('templates/blockquote-template', 'blockquote', '', $params);
