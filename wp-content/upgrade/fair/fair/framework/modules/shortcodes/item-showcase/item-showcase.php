<?php
namespace FairEdge\Modules\Shortcodes\ItemShowcase;
...
class ItemShowcase implements ShortcodeInterface	{
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Item Showcase', 'fair'),
			'base' => $this->base,
			'category' => 'by EDGE',
	...
	public function render($atts, $content = null) {
        ...
        $item_image_style = '';
        $item_image_style .= 'margin-top:' . fair_edge_filter_px($image_top_offset) . 'px;';

        $html .= '<div '. fair_edge_get_class_attribute($item_showcase_class) . '>';
            $html .= '<div class="edgtf-item-image" '. fair_edge_get_inline_style($item_image_style)  .'>';
                if ($item_image != '') {
