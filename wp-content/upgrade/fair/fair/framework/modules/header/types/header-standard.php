...
class HeaderStandard extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = fair_edge_filter_px(fair_edge_options()->getOptionValue('menu_area_height_header_standard'));
            ...
            $this->mobileHeaderHeight = $mobileHeaderHeight !== '' ? (int)$mobileHeaderHeight : 78;
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['menu_area_in_grid'] = fair_edge_options()->getOptionValue('menu_area_in_grid_header_standard') == 'yes' ? true : false;

        $parameters = apply_filters('fair_edge_header_standard_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        if(get_post_meta($id, 'edgtf_menu_area_background_color_header_standard_meta', true) !== ''){
            ...
            $menuAreaTransparent = fair_edge_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
                                   fair_edge_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '1';
        }
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        if(get_post_meta($id, 'edgtf_menu_area_background_color_header_standard_meta', true) !== ''){
            ...
            $menuAreaTransparent = fair_edge_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
                                   fair_edge_options()->getOptionValue('menu_area_background_transparency_header_standard') === '0';
        }
