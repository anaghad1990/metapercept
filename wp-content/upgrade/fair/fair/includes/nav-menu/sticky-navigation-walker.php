 ...
 */
if (!class_exists('FairEdgeStickyNavigationWalker')) {
	class FairEdgeStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if (fair_edge_options()->getOptionValue('enable_wide_menu_background') == "yes"){
			...
			if($item->hide == ""){
				...
				if($item->description !== "") {
					$item_output .= '<span class="edgtf-item-inner-desc"> ' . $item->description.'</span>';
				}				
